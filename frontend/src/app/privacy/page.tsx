      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Account data:</strong> email address, username, password (stored as a bcrypt hash — never in plain text)</li>
            <li><strong>Profile data:</strong> full name, bio, avatar (optional, provided by you)</li>
            <li><strong>Usage data:</strong> strategies you create, backtest results, forum posts, comments</li>
            <li><strong>Technical data:</strong> IP address (for rate limiting and security), request logs (retained for 30 days)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Consent:</strong> optional email notifications (you can opt out in dashboard settings)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Resend</strong> (resend.com) — email delivery. Your email address is passed to Resend solely to send transactional emails</li>
            <li><strong>Hetzner</strong> (hetzner.com) — server hosting in Germany (EU). Your data is stored on EU servers</li>
            <li><strong>Cloudflare</strong> (cloudflare.com) — DNS, DDoS protection, and email forwarding</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">7. Your Rights (UK GDPR)</h2>
          ...
          <p className="mt-3">To exercise any of these rights, email us at <a href="mailto:privacy@ceapcouncil.com" className="text-emerald-600 hover:text-emerald-700">privacy@ceapcouncil.com</a>. We will respond within 30 days.</p>
        </section>
        ...
        <section>
          ...
          <p>The Service is not directed at anyone under 18. We do not knowingly collect data from anyone under 18. If you believe we have collected data from a minor, contact us at <a href="mailto:privacy@ceapcouncil.com" className="text-emerald-600 hover:text-emerald-700">privacy@ceapcouncil.com</a>.</p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2">For privacy queries: <a href="mailto:privacy@ceapcouncil.com" className="text-emerald-600 hover:text-emerald-700">privacy@ceapcouncil.com</a></p>
          <p>You have the right to lodge a complaint with the <strong>Information Commissioner's Office (ICO)</strong> at <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">ico.org.uk</a> if you believe we have mishandled your data.</p>
        </section>

      </div>

      <div className="mt-12 pt-6 border-t border-gray-200">
        <Link href="/terms" className="text-emerald-600 hover:text-emerald-700 text-sm">
