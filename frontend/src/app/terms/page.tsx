...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Ceap Council',
};
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 sm:p-12">
          ...
          <div className="space-y-8 text-sm leading-relaxed text-gray-700">
            ...
            <section>
              ...
              <p>You must be at least 18 years old to create an account. By registering, you confirm you are 18 or older.</p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-gray-900 mb-3">3. Description of Service</h2>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>You must notify us immediately of any unauthorised access at <a href="mailto:support@ceapcouncil.com" className="text-emerald-600 hover:underline">support@ceapcouncil.com</a></li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 mb-3">6. User Content</h2>
            ...
            <section>
              ...
              <p>For any questions regarding these Terms, contact us at <a href="mailto:support@ceapcouncil.com" className="text-emerald-600 hover:underline">support@ceapcouncil.com</a>.</p>
            </section>
          ...
          <div className="mt-10 pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-4 text-sm text-gray-500">
            ...
            <a href="mailto:support@ceapcouncil.com" className="hover:text-gray-700">support@ceapcouncil.com</a>
          </div>
        </div>
      </div>
    </div>
